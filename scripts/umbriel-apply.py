#!/usr/bin/env python3
"""Umbriel appearance bridge for the jhqs settings app.
...
# Layer-rule namespace of the jhqs shell surfaces. The override rule written
...
def apply(payload: str) -> int:
    ...
    text = "\n".join([
        "# jhqs settings — generated by Appearance > Umbriel.",
