...
Singleton {
    readonly property var entries: [
        ...
        { id: "hyprland", title: "Compositor", icon: "󰖔", desc: "Layout, gaps, focus", category: "device",
          keywords: "compositor hyprland layout gaps window focus border shadow animations" },
